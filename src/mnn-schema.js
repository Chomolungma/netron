...
$root.MNN.Op = class Op {
    ...
    get defaultDimentionFormat() {
        ...
        return offset ? this._reader.int8(this._offset + offset) : NHWC;
    }
};
...
$root.MNN.Net = class Net {
    ...
    get preferForwardType() {
        const offset = this._reader.offset(this._offset, 14);
        return offset ? this._reader.int8(this._offset + offset) : CPU;
    }

    get sourceType() {
        const offset = this._reader.offset(this._offset, 16);
        return offset ? this._reader.int8(this._offset + offset) : CAFFE;
    }
    ...
    get usage() {
        ...
        return offset ? this._reader.int8(this._offset + offset) : INFERENCE;
    }
};
...
$root.MNN.QuantizedFloatParam = class QuantizedFloatParam {
    ...
    get method() {
        const offset = this._reader.offset(this._offset, 12);
        return offset ? this._reader.int8(this._offset + offset) : DEFAULT;
    }
};
...
$root.MNN.Pool = class Pool {
    ...
    get dataType() {
        const offset = this._reader.offset(this._offset, 22);
        return offset ? this._reader.int32(this._offset + offset) : DT_FLOAT;
    }
...
$root.MNN.Input = class Input {
    ...
    get dformat() {
        const offset = this._reader.offset(this._offset, 8);
        return offset ? this._reader.int8(this._offset + offset) : NC4HW4;
    }
};
...
$root.MNN.PadParam = class PadParam {
    ...
    get mode() {
        const offset = this._reader.offset(this._offset, 4);
        return offset ? this._reader.int8(this._offset + offset) : CONSTANT;
    }
};
...
$root.MNN.Dequantize = class Dequantize {
    ...
    get modelFormat() {
        const offset = this._reader.offset(this._offset, 8);
        return offset ? this._reader.int8(this._offset + offset) : TENSORFLOW;
    }
